...
async def list_permissions(
        ...
        _: User = Depends(has_permission("permission:list")),
):
    """
    获取权限列表
    """
...
async def create_permission(
        ...
        db: AsyncSession = Depends(get_db),
        _: User = Depends(has_permission("permission:create")),
):
    """
    创建新权限
    """
...
async def get_permission(
        permission_id: int,
        db: AsyncSession = Depends(get_db),
        _: User = Depends(has_permission("permission:read")),
):
    """
    获取特定权限
    """
...
async def update_permission(
        ...
        db: AsyncSession = Depends(get_db),
        _: User = Depends(has_permission("permission:update")),
):
    """
    更新权限
    """
...
async def delete_permission(
        permission_id: int,
        db: AsyncSession = Depends(get_db),
        _: User = Depends(has_permission("permission:delete")),
):
    """
    删除权限
    """
...
async def list_roles(
        ...
        limit: int = 100,
        db: AsyncSession = Depends(get_db),
        _: User = Depends(has_permission("role:list")),
):
    """
    获取角色列表
    """
...
async def create_role(
        role: RoleCreate,
        db: AsyncSession = Depends(get_db),
        _: User = Depends(has_permission("role:create")),
):
    """
    创建新角色
    """
...
async def get_role(
        role_id: int,
        db: AsyncSession = Depends(get_db),
        _: User = Depends(has_permission("role:read")),
):
    """
    获取特定角色
    """
...
async def update_role(
        ...
        db: AsyncSession = Depends(get_db),
        _: User = Depends(has_permission("role:update")),
):
    """
    更新角色
    """
...
async def delete_role(
        role_id: int,
        db: AsyncSession = Depends(get_db),
        _: User = Depends(has_permission("role:delete")),
):
    """
    删除角色
    """
...
async def update_user_roles(
        ...
        db: AsyncSession = Depends(get_db),
        _: User = Depends(has_permission("user:update_roles")),
):
    """
    更新用户的角色
    """
